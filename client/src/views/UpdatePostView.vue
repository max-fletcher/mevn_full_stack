            ...
            <v-col sm="10" class="mx-auto">
               <v-card class="pa-5">
                  ...
                  <v-form ref="form" class="pa-5" @submit.prevent="submitForm" enctype="multipart/form-data">
                     ...
                     <v-radio-group label="Category" v-model="post.category" prepend-icon="mdi-format-list-text" mandatory :rules="rules">
                        <v-radio label="Active" value="active"></v-radio>
                        <v-radio label="Inactive" value="inactive" ></v-radio>
                     </v-radio-group>

                     <v-textarea label="Description" prepend-icon="mdi-clipboard-text-outline" v-model="post.description" auto-grow rows="2" :rules="rules"></v-textarea>
...
<script>
   ...
   export default {
      ...
      async created() {
         this.post = await API.updatePost(this.postId)
